...
import { FaceSmileIcon, FaceFrownIcon, FireIcon, HeartIcon, PaperClipIcon, HandRaisedIcon, XMarkIcon} from '@heroicons/react/24/solid'
...
const moods = [
  ...
  { name: 'Thumbsy', value: 'thumbsy', icon: HandRaisedIcon, iconColor: 'text-white', bgColor: 'bg-blue-500' },
                      ...
                      <div className="relative">
                        <Listbox.Button className="relative -m-2.5 w-10 h-10 rounded-full flex items-center justify-center text-gray-400 hover:text-gray-500">
                          <span className="flex items-center justify-center">
                            {selected.value === null ? (
                              <span>
                                <FaceSmileIcon className="flex-shrink-0 h-5 w-5" aria-hidden="true" />
